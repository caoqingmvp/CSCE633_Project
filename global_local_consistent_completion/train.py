...
import cv2
import tqdm
from global_local_consistent_completion.network import Network
from global_local_consistent_completion import load
    ...
    while True:
        ...
        # Discrimination
            ...
            for i in tqdm.tqdm(range(step_num)):
                ...
                _, d_loss = sess.run([d_train_op, model.d_loss], feed_dict={x: x_batch, mask: mask_batch, local_x: local_x_batch, global_completion: completion, local_completion: local_completion_batch, is_training: True})
                d_loss_value += d_loss
